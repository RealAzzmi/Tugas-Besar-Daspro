...
def run():
    if variables.login == False:
        ...
        print(f"Bahan bangunanan yang dimilki: (pasir: {database.bahan_bangunan.bahan_list.sand}, batu: {database.bahan_bangunan.bahan_list.stone}, air: {database.bahan_bangunan.bahan_list.water}).")
        ...
        if database.candi.candi_list.size == MAX_CANDI:
            ...
            print(f"Sisa bahan bangunanan yang dimilki: (pasir: {database.bahan_bangunan.bahan_list.sand}, batu: {database.bahan_bangunan.bahan_list.stone}, air: {database.bahan_bangunan.bahan_list.water}).")
